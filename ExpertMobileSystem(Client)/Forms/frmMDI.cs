            ...
            try
            {
                ...
                switch (tName)
                {
                    ...
                    case TableNames.ORDER:
                        ...
                        unchanged = (from table2 in dtExpert.AsEnumerable()
                                     join table1 in dtLocal.AsEnumerable()
                                        on new { ColA = table2.Field<string>("Division"), ColB = table2.Field<string>("Ord_No"), ColC = table2.Field<DateTime?>("Ord_Dt"), ColD = table2.Field<string>("Code"), ColE = table2.Field<double?>("Ord_value"), ColF = table2.Field<string>("Bill_Ins"), ColG = table2.Field<string>("Pay_Terms"), ColI = table2.Field<string>("Del_Ins"), ColJ = table2.Field<Boolean>("Adjusted"), ColK = table2.Field<string>("Ship"), ColL = table2.Field<string>("TRPT"), ColM = table2.Field<Boolean>("Closed") } equals new { ColA = table1.Field<string>("Division"), ColB = table1.Field<string>("Ord_No"), ColC = table1.Field<DateTime?>("Ord_Dt"), ColD = table1.Field<string>("Code"), ColE = table1.Field<double?>("Ord_value"), ColF = table1.Field<string>("Bill_Ins"), ColG = table1.Field<string>("Pay_Terms"), ColI = table1.Field<string>("Del_Ins"), ColJ = table1.Field<Boolean>("Adjusted"), ColK = table1.Field<string>("Ship"), ColL = table1.Field<string>("TRPT"), ColM = table1.Field<Boolean>("Closed") }
                                     where table2.Field<string>("Division") != table1.Field<string>("Division") || table2.Field<string>("Ord_No") != table1.Field<string>("Ord_No") || table2.Field<DateTime?>("Ord_Dt") != table1.Field<DateTime?>("Ord_Dt") || table2.Field<string>("Code") != table1.Field<string>("Code") || table2.Field<double?>("Ord_value") != table1.Field<double?>("Ord_value") || table2.Field<string>("Bill_Ins") != table1.Field<string>("Bill_Ins") || table2.Field<string>("Pay_Terms") != table1.Field<string>("Pay_Terms") || table2.Field<string>("Del_Ins") != table1.Field<string>("Del_Ins") || table2.Field<Boolean>("Adjusted") != table1.Field<Boolean>("Adjusted") || table2.Field<string>("Ship") != table1.Field<string>("Ship") || table2.Field<string>("TRPT") != table1.Field<string>("TRPT") || table2.Field<Boolean>("Closed") != table1.Field<Boolean>("Closed")
                                     select table2);
                        ...
                        newinsertinlocal = from table2 in dtExpert.AsEnumerable()
                                           join table1 in dtLocal.AsEnumerable()
                                           on new { ColA = table2.Field<string>("Division"), ColB = table2.Field<string>("Ord_No"), ColC = table2.Field<DateTime?>("Ord_Dt"), ColD = table2.Field<string>("Code"), ColE = table2.Field<double?>("Ord_value"), ColF = table2.Field<string>("Bill_Ins"), ColG = table2.Field<string>("Pay_Terms"), ColI = table2.Field<string>("Del_Ins"), ColJ = table2.Field<Boolean>("Adjusted"), ColK = table2.Field<string>("Ship"), ColL = table2.Field<string>("TRPT"), ColM = table2.Field<Boolean>("Closed") } equals new { ColA = table1.Field<string>("Division"), ColB = table1.Field<string>("Ord_No"), ColC = table1.Field<DateTime?>("Ord_Dt"), ColD = table1.Field<string>("Code"), ColE = table1.Field<double?>("Ord_value"), ColF = table1.Field<string>("Bill_Ins"), ColG = table1.Field<string>("Pay_Terms"), ColI = table1.Field<string>("Del_Ins"), ColJ = table1.Field<Boolean>("Adjusted"), ColK = table1.Field<string>("Ship"), ColL = table1.Field<string>("TRPT"), ColM = table1.Field<Boolean>("Closed") } into tg
                                           from tcheck in tg.DefaultIfEmpty()
                                           where tcheck == null
                                           select table2;
                        ...
                        deletefromlocal = from table1 in dtLocal.AsEnumerable()
                                          join table2 in dtExpert.AsEnumerable()
                                          on new { ColA = table1.Field<string>("Division"), ColB = table1.Field<string>("Ord_No"), ColC = table1.Field<DateTime?>("Ord_Dt"), ColD = table1.Field<string>("Code"), ColE = table1.Field<double?>("Ord_value"), ColF = table1.Field<string>("Bill_Ins"), ColG = table1.Field<string>("Pay_Terms"), ColI = table1.Field<string>("Del_Ins"), ColJ = table1.Field<Boolean>("Adjusted"), ColK = table1.Field<string>("Ship"), ColL = table1.Field<string>("TRPT"), ColM = table1.Field<Boolean>("Closed") } equals new { ColA = table2.Field<string>("Division"), ColB = table2.Field<string>("Ord_No"), ColC = table2.Field<DateTime?>("Ord_Dt"), ColD = table2.Field<string>("Code"), ColE = table2.Field<double?>("Ord_value"), ColF = table2.Field<string>("Bill_Ins"), ColG = table2.Field<string>("Pay_Terms"), ColI = table2.Field<string>("Del_Ins"), ColJ = table2.Field<Boolean>("Adjusted"), ColK = table2.Field<string>("Ship"), ColL = table2.Field<string>("TRPT"), ColM = table2.Field<Boolean>("Closed") } into tg
                                          from tcheck in tg.DefaultIfEmpty()
                                          where tcheck == null
                                          select table1;
                        if (deletefromlocal != null && deletefromlocal.Count() > 0)
